        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-4 lg:sticky lg:top-28 space-y-6 animate-fade-in-up" style="animation-delay: 400ms;">
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <a href="/contacto" class="w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-primary hover:bg-secondary text-white font-bold rounded-2xl transition-all shadow-lg shadow-primary/20 hover:shadow-secondary/30 transform hover:-translate-y-0.5">
