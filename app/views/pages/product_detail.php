<?php $this->component('header', ['title' => $title ?? 'Detalle del Producto']); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div class="lg:col-span-6 lg:sticky lg:top-32 animate-fade-in-up" style="animation-delay: 200ms;">
                ...
                <button onclick="openContactModal('Consulta sobre producto: <?= addslashes(htmlspecialchars($product['title'])) ?>')" class="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary hover:bg-secondary text-white font-bold rounded-xl transition-all shadow-lg shadow-primary/20 hover:shadow-secondary/30 transform hover:-translate-y-0.5 mt-4">
