<?php $this->component('header', ['title' => $title ?? 'Contacto']); ?>
        ...
        <div class="max-w-6xl mx-auto bg-white/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden flex flex-col md:flex-row animate-fade-in-up">
            ...
            <div class="md:w-2/5 bg-primary p-12 lg:p-16 text-white flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <h2 class="text-4xl font-extrabold mb-6">Hablemos de negocios</h2>
                    <p class="text-gray-300 mb-12 leading-relaxed text-lg">Ponte en contacto con nuestro equipo comercial para agendar una consultoría de evaluación y escalar la tecnología de tu empresa.</p>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-lg text-white">Sede Central</h4>
                                <p class="text-gray-400 mt-1">Torre Empresarial Andina, Piso 12<br>Bogotá, Colombia</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-white/10 p-3 rounded-xl mr-5">
                            ...
                            <div>
                                <h4 class="font-semibold text-lg text-white">Correo Corporativo</h4>
                                <p class="text-gray-400 mt-1">contacto@syncroandina.com</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-white/10 p-3 rounded-xl mr-5">
                            ...
                            <div>
                                <h4 class="font-semibold text-lg text-white">Línea de Atención</h4>
                                <p class="text-gray-400 mt-1">+57 300 123 4567</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="md:w-3/5 p-12 lg:p-16">
                <h3 class="text-3xl font-extrabold text-gray-900 mb-8">Envíanos un mensaje</h3>
