...
<main class="min-h-screen bg-gray-50 pt-20 pb-32">
    <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-20 animate-fade-in-up">
            <h1 class="text-4xl md:text-5xl font-extrabold text-primary mb-6">Casos de Éxito</h1>
            <p class="text-xl text-gray-600">Proyectos emblemáticos que demuestran nuestro compromiso absoluto con la calidad corporativa y la entrega de valor real.</p>
        </div>
