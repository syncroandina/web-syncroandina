...
<?php else: ?>
                    ...
                    <div class="pt-2">
                        ...
                        <input type="text" name="logo_alt" value="<?= htmlspecialchars($settings['logo_alt'] ?? 'Logotipo Corporativo') ?>" class="w-full border-gray-200 rounded-xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-3.5 text-sm bg-gray-50 transition-all" placeholder="Ej: Logotipo de la Empresa">
                    </div>
                </div>
