        ...
        <aside class="flex-shrink-0 w-64 bg-primary text-white transition-all duration-300 shadow-2xl relative z-20" :class="{'w-64': sidebarOpen, 'w-20': !sidebarOpen, 'hidden md:block': !sidebarOpen}">
            <div class="h-16 flex items-center justify-center border-b border-white/10 bg-black/20">
                <span class="text-2xl font-black tracking-tight" x-show="sidebarOpen">SYNCRO ANDINA</span>
            ...
            <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)] custom-scrollbar">
                ...
                <a href="/admin/inicio" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    ...
                    <span x-show="sidebarOpen" class="text-sm font-medium">Inicio</span>
                </a>
                ...
                <a href="/admin/productos" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                ...
                <a href="/admin/blog" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                ...
                <a href="/admin/clientes" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                ...
                <a href="/admin/lugares" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    <span x-show="sidebarOpen" class="text-sm font-medium">Lugares (Ciudades/Distritos)</span>
                </a>
                ...
                <a href="/admin/notificaciones" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                    <span x-show="sidebarOpen" class="text-sm font-medium">Notificaciones</span>
                </a>
                <a href="/admin/scripts" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
                    <span x-show="sidebarOpen" class="text-sm font-medium">Scripts Seguimiento</span>
                </a>
                <a href="/admin/actualizaciones" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    ...
                    <span x-show="sidebarOpen" class="text-sm font-medium">Actualizaciones GitHub</span>
                </a>
                <a href="/admin/backup-site" class="flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl transition-colors">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4"></path></svg>
                    <span x-show="sidebarOpen" class="text-sm font-medium">Exportar e Importar</span>
                </a>
            </nav>
        </aside>
