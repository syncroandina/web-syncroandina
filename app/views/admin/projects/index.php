    ...
    <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 max-w-3xl w-full mx-4 overflow-hidden transform scale-95 transition-all duration-300 flex flex-col max-h-[90vh]" id="settings-modal-container">
        <div class="px-8 py-6 bg-gray-50 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            <h3 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                ...
                Configurar Textos y Ajustes de Proyectos
            </h3>
        ...
        <form action="<?= url('admin/proyectos/settings') ?>" method="POST" class="p-8 space-y-6 overflow-y-auto flex-1">
            <input type="hidden" name="csrf_token" value="<?= \Core\Security::generateCSRFToken() ?>">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="projects_home_title" value="<?= htmlspecialchars($settings['projects_home_title'] ?? 'Nuestros Proyectos Recientes') ?>" required class="w-full border-gray-200 rounded-2xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-4 text-sm bg-gray-50">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 pl-1">Subtítulo de la Sección</label>
                    <textarea name="projects_home_subtitle" rows="2" required class="w-full border-gray-200 rounded-2xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-4 text-sm bg-gray-50 resize-none"><?= htmlspecialchars($settings['projects_home_subtitle'] ?? 'Casos de éxito que demuestran nuestra capacidad de ejecución e innovación.') ?></textarea>
                </div>
                <div>
                    ...
                    <input type="number" name="carousel_projects_speed" min="500" max="20000" step="100" value="<?= htmlspecialchars($settings['carousel_projects_speed'] ?? '3000') ?>" required class="w-full border-gray-200 rounded-2xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-4 text-sm bg-gray-50">
            ...
            <div class="space-y-4">
                <h4 class="text-xs font-black text-secondary uppercase tracking-widest pl-2 border-l-4 border-secondary">Página Principal de Proyectos General (/proyectos)</h4>
                
                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 pl-1">Título de la Página</label>
                    <input type="text" name="projects_page_title" value="<?= htmlspecialchars($settings['projects_page_title'] ?? 'Casos de Éxito') ?>" required class="w-full border-gray-200 rounded-2xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-4 text-sm bg-gray-50">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 pl-1">Subtítulo de la Página</label>
                    <textarea name="projects_page_subtitle" rows="2" required class="w-full border-gray-200 rounded-2xl focus:ring-2 focus:ring-secondary/20 focus:border-secondary p-4 text-sm bg-gray-50 resize-none"><?= htmlspecialchars($settings['projects_page_subtitle'] ?? 'Proyectos emblemáticos que demuestran nuestro compromiso absoluto con la calidad corporativa y la entrega de valor real.') ?></textarea>
                </div>
            </div>
            ...
            <!-- OPTIMIZACIÓN SEO -->
            <div class="space-y-4">
                <h5 class="text-xs font-black text-secondary uppercase tracking-widest pl-2 border-l-4 border-secondary">Optimización SEO (Página /proyectos)</h5>
