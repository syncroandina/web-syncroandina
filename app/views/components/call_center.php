...
<style>
    .cc-widget-container {
        ...
        pointer-events: none; /* Evita bloquear clics en la pantalla cuando está cerrado */
    }
    ...
    .cc-trigger {
        ...
        outline: none;
        padding: 0;
        pointer-events: auto; /* Permite clics en el botón disparador */
    }
...
<div class="cc-widget-container" id="cc-widget">
    ...
    <div class="cc-popup" id="cc-popup-window">
        ...
        <div class="cc-popup-header">
            <div class="cc-header-content">
                ...
                <div class="cc-header-text">
                    <p class="cc-header-title"><?= htmlspecialchars($mainTitle) ?></p>
        ...
        <div class="cc-popup-body">
            ...
            ?>
                <a href="<?= $link ?>" target="_blank" onclick="trackInteraction('<?= $contact['type'] ?>', '<?= $link ?>')" class="cc-contact-link <?= $cssClass ?>">
